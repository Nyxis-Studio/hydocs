...
## Overview
- Documentation for `SensorAdjustPosition`.
- Declared as a class in `com.hypixel.hytale.server.npc.corecomponents.utility`.

## Constructors
- `SensorAdjustPosition(@Nonnull BuilderSensorAdjustPosition builder, @Nonnull BuilderSupport support, Sensor sensor)`
  - Creates a `SensorAdjustPosition` instance.
