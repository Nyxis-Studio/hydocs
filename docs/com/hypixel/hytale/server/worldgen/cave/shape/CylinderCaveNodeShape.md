...
## Overview
- Documentation for `CylinderCaveNodeShape`.
- Declared as a class in `com.hypixel.hytale.server.worldgen.cave.shape`.

## Constructors
- `CylinderCaveNodeShape(CaveType caveType, @Nonnull Vector3d o, @Nonnull Vector3d v, double radius1, double radius2, double middleRadius)`
  - Creates a `CylinderCaveNodeShape` instance.
- `CylinderCaveNodeShape(caveType, origin, direction, radius1, radius2, radius3)`
  - Creates a `CylinderCaveNodeShape` instance.
